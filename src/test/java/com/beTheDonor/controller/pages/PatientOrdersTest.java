...
@WebMvcTest(controllers = PatientOrders.class)
@AutoConfigureMockMvc
class PatientOrdersTest {
    ...
    @BeforeEach
    void setUp() {
        patientOrders = Mockito.spy(patientOrders);
        mockMvc = MockMvcBuilders.standaloneSetup(patientOrders).build();
    }
    @Test
